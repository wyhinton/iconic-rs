...
fn main() {
    ...
    let rows = 12;
    let cols = 14;
	let mut frame = Frame::new(100, 100,50 as i32, 20 as i32+20, None);
	frame.set_label("TESTEST");
	frame.set_tooltip("TESTTEST");
	let mut f2 = Frame::new(300, 100,50 as i32, 20 as i32+20, None);
	f2.set_label("TESTEST");
	f2.set_tooltip("TESTTEST");

	let mut frame = Frame::new(100, 150,50 as i32, 20 as i32+20, None);
	frame.set_label("TESTEST");
	frame.set_tooltip("TESTTEST");
	let mut f2 = Frame::new(170, 150,50 as i32, 20 as i32+20, None);
	f2.set_label("TESTEST");
	f2.set_tooltip("TESTTEST");
...
//     let rows = 12;
//     let cols = 14;
//     // let mut group= Group::new(50,100,400,400,"Octicons");
//     let mut container= Pack::new(50,100,500,400,None);
// 	// let octicon_names = vec!['HEART', 'ZAP', 'LIGHTBULB', 'REPO', 'REPOFORKED', 'REPOPUSH', 'REPOPULL', 'BOOK', 'OCTOFACE', 'GITPULLREQUEST', 'MARKGITHUB', 'CLOUDDOWNLOAD', 'CLOUDUPLOAD', 'KEYBOARD', 'GIST', 'FILECODE', 'FILETEXT', 'FILEMEDIA', 'FILEZIP', 'FILEPDF', 'TAG', 'FILEDIRECTORY', 'FILESUBMODULE', 'PERSON', 'JERSEY', 'GITCOMMIT', 'GITBRANCH', 'GITMERGE', 'MIRROR', 'ISSUEOPENED', 'ISSUEREOPENED', 'ISSUECLOSED', 'STAR', 'COMMENT', 'QUESTION', 'ALERT', 'SEARCH', 'GEAR', 'RADIOTOWER', 'TOOLS', 'SIGNOUT', 'ROCKET', 'RSS', 'CLIPPY', 'SIGNIN', 'ORGANIZATION', 'DEVICEMOBILE', 'UNFOLD', 'CHECK', 'MAIL', 'MAILREAD', 'ARROWUP', 'ARROWRIGHT', 'ARROWDOWN', 'ARROWLEFT', 'PIN', 'GIFT', 'GRAPH', 'TRIANGLELEFT', 'CREDITCARD', 'CLOCK', 'RUBY', 'BROADCAST', 'KEY', 'REPOFORCEPUSH', 'REPOCLONE', 'DIFF', 'EYE', 'COMMENTDISCUSSION', 'MAILREPLY', 'PRIMITIVEDOT', 'PRIMITIVESQUARE', 'DEVICECAMERA', 'DEVICECAMERAVIDEO', 'PENCIL', 'INFO', 'TRIANGLERIGHT', 'TRIANGLEDOWN', 'LINK', 'PLUS', 'THREEBARS', 'CODE', 'LOCATION', 'LISTUNORDERED', 'LISTORDERED', 'QUOTE', 'VERSIONS', 'CALENDAR', 'LOCK', 'DIFFADDED', 'DIFFREMOVED', 'DIFFMODIFIED', 'DIFFRENAMED', 'HORIZONTALRULE', 'ARROWSMALLRIGHT', 'MILESTONE', 'CHECKLIST', 'MEGAPHONE', 'CHEVRONRIGHT', 'BOOKMARK', 'SETTINGS', 'DASHBOARD', 'HISTORY', 'LINKEXTERNAL', 'MUTE', 'X', 'CIRCLESLASH', 'PULSE', 'SYNC', 'TELESCOPE', 'GISTSECRET', 'HOME', 'STOP', 'BUG', 'LOGOGITHUB', 'FILEBINARY', 'DATABASE', 'SERVER', 'DIFFIGNORED', 'ELLIPSIS', 'NONEWLINE', 'HUBOT', 'ARROWSMALLUP', 'ARROWSMALLDOWN', 'ARROWSMALLLEFT', 'CHEVRONUP', 'CHEVRONDOWN', 'CHEVRONLEFT', 'TRIANGLEUP', 'GITCOMPARE', 'LOGOGIST', 'FILESYMLINKFILE', 'FILESYMLINKDIRECTORY', 'SQUIRREL', 'GLOBE', 'UNMUTE', 'MENTION', 'PACKAGE', 'BROWSER', 'TERMINAL', 'MARKDOWN', 'DASH', 'FOLD', 'INBOX', 'TRASHCAN', 'PAINTCAN', 'FLAME', 'BRIEFCASE', 'PLUG', 'CIRCUITBOARD', 'MORTARBOARD', 'LAW', 'THUMBSUP', 'THUMBSDOWN', 'DESKTOPDOWNLOAD', 'BEAKER', 'BELL', 'WATCH', 'SHIELD', 'BOLD', 'TEXTSIZE', 'ITALIC', 'TASKLIST', 'VERIFIED', 'SMILEY', 'UNVERIFIED', 'DEVICEDESKTOP']
